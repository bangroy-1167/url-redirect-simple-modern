...
interface UrlInfo {
  ...
  title?: string;
  keterangan?: string;
  description?: string; // Also check description field
}
...
export default function UrlFoundPage() {
  ...
  console.log('[DEBUG UrlFoundPage] settings.autoRedirect:', settings.autoRedirect);
        ...
        {urlInfo && (
          <div className="bg-gray-50 rounded-xl p-4 mb-6">
            <div className="mb-3">
              ...
              <code className="text-sm font-mono bg-white px-3 py-2 rounded border block overflow-x-auto">
